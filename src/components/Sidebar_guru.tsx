...
const SidebarGuru: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          "fixed top-20 left-0 w-64 h-[calc(100%-4rem)] bg-red-500 shadow-md text-white z-50 transform transition-transform duration-300 ease-in-out",
          {
