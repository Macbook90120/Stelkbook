...
function Page() {
  ...
  const handleKimiaClick = (bookName: string) => {
    router.push(`/Buku_XI/${bookName}_XI`); // Navigasi ke buku Kimia
  }; 

  const handleSejarahClick = (bookName: string) => {
    router.push(`/Buku_XI/${bookName}_XI`); // Navigasi ke buku Sejarah
  }; 

  const handleFisikaClick = (bookName: string) => {
    router.push(`/Buku_XI/${bookName}_XI`); // Navigasi ke buku Fisika
  }; 

  const handleGeografiClick = (bookName: string) => {
    router.push(`/Buku_XI/${bookName}_XI`); // Navigasi ke buku geografi
  };

  const handleEkonomiClick = (bookName: string) => {
    router.push(`/Buku_XI/${bookName}_XI`); // Navigasi ke buku Ekonomi
  }; 

  const handleMatematikaClick = (bookName: string) => {
    router.push(`/Buku_XI/${bookName}_XI`); // Navigasi ke buku Matematika
  }; 

  const handleBahasaIndonesiaClick = (bookName: string) => {
    router.push(`/Buku_XI/${bookName}_XI`); // Navigasi ke buku Bahasa Indonesia
  }; 
    ...
    <div className="min-h-screen p-8 bg-gray-50 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 justify-items-center">
        <div className="text-center cursor-pointer" onClick={() => handleEkonomiClick('Ekonomi')}>
          ...
          <p className="mt-2 text-sm font-poppins font-semibold translate-x-[140px] translate-y-[10px]">
            Buku paket Ekonomi  <br/> Kelas XI
          </p>
        </div>
        <div className="text-center cursor-pointer" onClick={() => handleMatematikaClick('Matematika')}>
          ...
          <p className="mt-2 text-sm font-poppins font-semibold translate-x-[28px] translate-y-[10px]">
            Buku paket Matematika Untuk  <br/> Kelas XI 
          </p>
        </div>
        <div className="text-center cursor-pointer" onClick={() => handleBahasaIndonesiaClick('BahasaIndonesia')}>
          ...
          <p className="mt-2 text-sm font-poppins font-semibold translate-x-[-80px] translate-y-[10px]">
            Buku paket Bahasa Indonesia  <br/> Kelas XI
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 justify-items-center mt-8">
        <div className="text-center cursor-pointer" onClick={() => handleSejarahClick('Sejarah')}>
          <Image
            ...
            className="mx-auto translate-x-[140px]"
          />
          <p className="mt-2 text-sm translate-x-[140px] translate-y-[15px] font-poppins font-semibold">
            Buku paket Sejarah <br/> Kelas XI
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 justify-items-center mt-8">
        <div className="text-center cursor-pointer" onClick={() => handleGeografiClick('Geografi')}>
          ...
          />
          <p className="mt-2 text-sm translate-x-[10px] translate-y-[10px] font-poppins font-semibold">
            Buku paket Geografi  <br/> Kelas XI
          </p>
        </div>
        {/* New Book Section */}
        <div className="text-center cursor-pointer" onClick={() => handlePancasilaClick('Pancasila')}>
          ...
          />
          <p className="mt-2 text-sm translate-x-[-335px] translate-y-[10px] font-poppins font-semibold">
            Buku paket Pancasila  <br/> Kelas XI
          </p>
        </div>
      </div>
    </div>
