...
function HomePage() {
  ...
  const classes = [
    { name: 'Kelas X', route: 'kelasX_guru', color: 'bg-green-500', texture: '/assets/texture/001.svg' },
    { name: 'Kelas XI', route: 'kelasXI_guru', color: 'bg-fuchsia-700', texture: '/assets/texture/002.svg' },
    { name: 'Kelas XII', route: 'kelasXII_guru', color: 'bg-cyan-600', texture: '/assets/texture/003.svg' },
  ];
