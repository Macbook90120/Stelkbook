...
function EditUserPerpusContent() {
  ...
  const { fetchPerpus, perpusDetail, updatePerpus, user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error updating data perpus:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gradient-to-br from-red-50 to-orange-50">
        <div className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-xl">
          ...
          <p className="mt-4 text-gray-600 font-medium">Memuat data perpus...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 lg:mb-8">
            <div className="flex items-center text-sm text-gray-600 mb-2 flex-wrap gap-1">
              ...
              <FaChevronRight className="mx-1 text-xs" />
              <span className="text-red-600 font-medium">Edit User Perpus</span>
            </div>
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Anda sedang mengelola data pengguna perpustakaan
              </p>
            </div>
            
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-800">Edit User Perpus</h2>
                <p className="text-gray-500 mt-1">Perbarui informasi data pengguna perpustakaan</p>
              </div>
              <button
                onClick={() => router.back()}
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Anda memiliki akses penuh ke manajemen data perpustakaan
                </p>
              </div>
            </div>
          </div>

          {/* Form Edit User Perpus */}
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 lg:col-span-2">
                <label className="text-sm font-medium text-gray-700 flex items-center">
                  <FaLandmark className="mr-2 text-red-500" />
                  Status
                </label>
                <input
                  type="text"
          ...
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <button
              ...
              className="bg-white p-3 rounded-lg shadow hover:shadow-md transition-shadow flex flex-col items-center space-y-1"
            >
              <FaChild className="text-red-500 text-lg" />
              <span className="text-xs text-gray-600">Siswa SD</span>
            </button>
            <button
