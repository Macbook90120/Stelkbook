...
function EditUserContent() {
  ...
  const { fetchGuruSmk, guruSmkDetail, updateGuruSmk, user } = useAuth();
  ...
  useEffect(() => {
    if (guruSmkDetail) {
      ...
      if (!guruSmkDetail.avatar) {
        ...
        setPreviewImage(getStorageUrl(guruSmkDetail.avatar));
      }
    }
  }, [guruSmkDetail]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error updating guru SMK:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gradient-to-br from-red-50 to-orange-50">
        <div className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-xl">
          ...
          <p className="mt-4 text-gray-600 font-medium">Memuat data guru SMK...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 lg:mb-8">
            <div className="flex items-center text-sm text-gray-600 mb-2 flex-wrap gap-1">
              ...
              <span 
                onClick={() => router.push('/admin_perpus/Sekolah_Guru/Data_SMK')}
                className="hover:text-red-600 cursor-pointer transition-colors"
              >
                Data Guru SMK
              </span>
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Anda sedang mengelola data guru Sekolah Menengah Kejuruan (SMK)
              </p>
            </div>
            
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-800">Edit Guru SMK</h2>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Anda memiliki akses penuh ke manajemen data guru SMK
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            >
              ...
              <span className="text-xs text-gray-600">Guru SMK</span>
            </button>
            <button
