  ...
  return (
    <div className="min-h-screen p-4 bg-white">
      ...
      <header className="pt-20 px-8">
        ...
        onClick={() => handleButtonClicked('admin_perpus/')}>
      ...
      <main className="flex flex-col gap-10 pt-6 items-center">
        {/* SD */}
        <button
          onClick={() => handleButtonClick('admin_perpus/Sekolah_Guru/Data_SD')}
        ...
        {/* SMP */}
        <button
          onClick={() => handleButtonClick('admin_perpus/Sekolah_Guru/Data_SMP')}
        ...
        {/* SMA/SMK */}
        <button
          onClick={() => handleButtonClick('admin_perpus/Sekolah_Guru/Data_SMK')}
