...
function Page() {
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-gray-50">
      <Head>
        <title>Tambah Petugas Perpus - StelkBook</title>
        <link 
          rel="preload" 
      ...
      <div className="mb-6 md:mb-8 flex items-center space-x-2">
        ...
        <p className="text-sm md:text-lg font-medium text-gray-900 font-poppins">Tambah Petugas Perpus</p>
      </div>
      ...
      <div className="flex justify-center">
        <div className="bg-white border border-gray-300 rounded-lg p-4 md:p-8 shadow-lg w-full max-w-4xl">
          ...
          {/* Title */}
          <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-6 text-center">Tambah Petugas Perpus Baru</h2>
