  ...
  return (
    <div className="min-h-screen p-4 bg-white">
      ...
      <main className="flex flex-col gap-10 pt-6 items-center">
        {/* SD */}
        <button
          onClick={() => handleButtonClick('admin_perpus/Sekolah_Siswa/Data_SD')}
        ...
        {/* SMP */}
        <button
          onClick={() => handleButtonClick('admin_perpus/Sekolah_Siswa/Data_SMP')}
        ...
        {/* SMK */}
        <button
          onClick={() => handleButtonClick('admin_perpus/Sekolah_Siswa/Data_SMK')}
