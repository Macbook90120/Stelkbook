...
function EditUserContent() {
  ...
  const { fetchSiswaSd, siswaSdDetail, updateSiswaSd, user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error updating siswa SD:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gradient-to-br from-red-50 to-orange-50">
        <div className="flex flex-col items-center bg-white p-8 rounded-2xl shadow-xl">
          ...
          <p className="mt-4 text-gray-600 font-medium">Memuat data siswa SD...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="mb-6 lg:mb-8">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Anda sedang mengelola data siswa Sekolah Dasar (SD)
              </p>
            </div>
            
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-800">Edit Siswa SD</h2>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Anda memiliki akses penuh ke manajemen data siswa SD
                </p>
              </div>
            </div>
          </div>
