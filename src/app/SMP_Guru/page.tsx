...
function HomePage() {
  ...
  const classes = [
    { name: 'Kelas VII', route: 'kelasVII_guru', color: 'bg-pink-400', texture: '/assets/texture/004.svg' },
    { name: 'Kelas VIII', route: 'kelasVIII_guru', color: 'bg-blue-500', texture: '/assets/texture/007.svg' },
    { name: 'Kelas IX', route: 'kelasIX_guru', color: 'bg-teal-500', texture: '/assets/texture/008.svg' },
  ];
