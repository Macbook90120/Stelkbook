      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 justify-center">
          <BookCard
            ...
            altText="Ekonomi SMA Kelas III"
            title="Buku paket Ekonomi Kelas III"
            onClick={() => navigateToBook('Ekonomi')}
          />
          <BookCard
            imageSrc="/assets/Kelas_XI/Buku_Matematika.png"
            altText="Matematika SMA Kelas III"
            title="Buku paket Matematika Kelas III"
            onClick={() => navigateToBook('Matematika')}
          />
          <BookCard
            imageSrc="/assets/Kelas_XI/Buku_Bahasa_Indonesia.png"
            altText="Bahasa Indonesia SMA Kelas III"
            title="Buku paket Bahasa Indonesia Kelas III"
            onClick={() => navigateToBook('BahasaIndonesia')}
          />
          <BookCard
            imageSrc="/assets/Kelas_XI/Buku_Sejarah.png"
            altText="Sejarah SMA Kelas III"
            title="Buku paket Sejarah Kelas III"
            onClick={() => navigateToBook('Sejarah')}
          />
          <BookCard
            imageSrc="/assets/Kelas_XI/Buku_Fisika.png"
            altText="Fisika SMA Kelas III"
            title="Buku paket Fisika Kelas III"
            onClick={() => navigateToBook('Fisika')}
          />
          <BookCard
            imageSrc="/assets/Kelas_XI/Buku_Kimia.png"
            altText="Kimia SMA Kelas III"
            title="Buku paket Kimia Kelas III"
            onClick={() => navigateToBook('Kimia')}
          />
          <BookCard
            imageSrc="/assets/Kelas_XI/Buku_Geografi.png"
            altText="Geografi SMA Kelas III"
            title="Buku paket Geografi Kelas III"
            onClick={() => navigateToBook('Geografi')}
          />
          <BookCard
            imageSrc="/assets/Kelas_XI/Buku_Pancasila.png"
            altText="Pancasila SMA Kelas III"
            title="Buku paket Pancasila Kelas III"
