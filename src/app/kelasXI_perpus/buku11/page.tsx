...
const Page: React.FC = () => {
  ...
  const { fetchKelas11BookById, deleteBookKelas11, getBookPdfUrl } = useBook(); // ✅ Ambil fungsi getBookPdfUrl
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              onClick={() => router.push(`/kelasXI_perpus/buku11/Edit_Buku?id=${book.id}`)}
