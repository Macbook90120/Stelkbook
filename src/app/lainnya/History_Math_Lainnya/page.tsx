          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku Sejarah Matematika<br /> History Of Mathematics Third Edition
              </h2>
              <ul className="mt-2 text-sm space-y-1">
                <li className="whitespace-nowrap">
                  <strong>Penerbit:</strong> Isaac Asimov
                </li>
                <li className="whitespace-nowrap">
                  <strong>Penulis:</strong> Uta C.Merzberch/Carl B. Boyer
                </li>
                <li className="whitespace-nowrap">
                  <strong>Tahun:</strong> 2014
                </li>
                <li className="whitespace-nowrap">
                  <strong>ISBN:</strong> 9786022997210
                </li>
              </ul>
            </div>
          </div>
