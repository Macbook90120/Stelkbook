...
function Page() {
  ...
  const handleKelasXIClick = () => {
    router.push("/kelasXI"); // Navigate to kelasXI
  };
  ...
  const handleBabClick = (chapterName: string) => {
    router.push(`/Buku_XI/Fisika_XI/${chapterName}_Fisika_XI`); // Navigasi ke bab-1, bab-2, etc.
  };
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku Paket <br /> Mandiri Fisika <br /> SMA/MA Kelas XI
              </h2>
