...
function Page() {
  ...
  const handleBabClick = (chapterName: string) => {
    router.push(`/Buku_XI/Matematika_XI/${chapterName}_Matematika_XI`); // Navigasi ke bab-1, bab-2, etc.
  };
    ...
    <>
      ...
      <div className="h-screen p-8 bg-gray-50 overflow-hidden">
        ...
        <div className="mb-8 flex items-center">
          ...
          <p className="text-xl font-semibold font-poppins cursor-pointer" onClick={handleKelasXIClick} >Kelas XI</p>
          <div className="mx-2">
            <Image src="/assets/Kelas_X/Primary_Direct.png" alt="Breadcrumb Divider" width={10} height={16} />
          </div>
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku Paket <br /> Matematika Untuk <br /> SMA/MA Kelas XI Kelompok Wajib
              </h2>
