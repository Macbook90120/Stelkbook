...
import Navbar from "@/components/Navbar_Admin_Perpus_SMK";
...
const SearchSiswaSMKContent: React.FC = () => {
    ...
    <div className="min-h-screen p-8 bg-gray-50 overflow-y-auto">
      ...
      <div className="relative mb-4">
        <button
          ...
          onClick={() => router.push("/admin_perpus/Create_User_Siswa_SMK")}
          title="Create_User"
        >
          +
        </button>
              ...
              >
                ...
                <div className="col-span-8 flex justify-end space-x-2">
                  <button
                    ...
                    onClick={() => router.push(`/admin_perpus/Sekolah_Siswa/Data_SMK/Edit_user?id=${siswa.id}`)}
                  >
                  <Image
...
export default function SearchSiswaSMK() {
  return (
    <Suspense fallback={
