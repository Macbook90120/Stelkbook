...
const Page: React.FC = () => {
  ...
  const { fetchKelas2BookById, deleteBookKelas2, getBookPdfUrl } = useBook(); // ✅ Ambil fungsi getBookPdfUrl
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              onClick={() => router.push(`/kelasII_perpus/buku2/Edit_Buku?id=${book.id}`)}
