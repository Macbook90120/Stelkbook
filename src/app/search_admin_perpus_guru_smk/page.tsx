...
function SearchGuruSMK() {
  ...
  const handleEditUser = (guru: Guru) => {
    router.push(`/admin_perpus/Sekolah_Guru/Data_SMK/Edit_user?id=${guru.id}`);
  };
    ...
    <div className="min-h-screen p-8 bg-gray-50 overflow-y-auto">
      ...
      <div className="relative mb-4">
        <button
          ...
          onClick={() => router.push("/admin_perpus/Create_User_Guru_SMK")}
          title="Create_User"
        >
          +
        </button>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          {filteredGuru?.length > 0 ? (
            ...
            <p className="text-gray-500 text-center py-4">
              {query ? "Tidak ada hasil ditemukan untuk pencarian Anda." : "Tidak ada data guru SMK tersedia."}
            </p>
          )}
        </div>
      )}
