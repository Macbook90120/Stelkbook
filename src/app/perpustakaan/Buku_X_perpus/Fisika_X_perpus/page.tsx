  ...
  return (
    <div className="h-screen p-8 bg-gray-50 overflow-y-auto">
      ...
      <div className="mb-8 flex items-center justify-start">
        ...
        <Image src="/assets/Kelas_X/Primary_Direct.png" alt="Breadcrumb Divider" width={10} height={16} className="mx-2" />
        <p className="text-xl font-semibold font-poppins">Buku Paket Mandiri Fisika</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-lg font-bold">Buku Paket <br /> Mandiri Fisika <br /> SMA/MA Kelas X </h2>
            <ul className="mt-2 text-sm space-y-1">
              <li><strong>Penerbit:</strong> Penerbit Erlangga</li>
              <li><strong>Penulis:</strong> Ni Ketut Lasmi</li>
              <li><strong>Tahun:</strong> 2020</li>
              <li><strong>ISBN:</strong> 9786024340261</li>
            </ul>
          </div>

          {/* Buttons */}
          <div className="mt-4 flex flex-col gap-2">
            <button onClick={() => router.push("/perpustakaan/Edit_Buku/Edit_Fisika_X")} className="bg-green-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-600 flex items-center gap-2">
