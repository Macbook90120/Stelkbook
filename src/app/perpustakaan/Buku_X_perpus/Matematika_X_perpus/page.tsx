          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-base font-bold translate-y-[-30px]">
                Buku Paket Kimia <br /> Matematika  <br /> Untuk SMA/MA Kelas X  <br /> Kelompok Wajib
              </h2>
              <ul className="mt-2 text-xs space-y-1 translate-y-[-35px]">
            ...
            <div className="mt-4 flex flex-col gap-2">
              <button onClick={() => router.push("/perpustakaan/Edit_Buku/Edit_Matematika_X")} className="bg-green-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-600 transition scale-100 duration-300 translate-y-[-40px] translate-x-[40px]">
                Edit Buku
              </button>
              <button
                onClick={() => setShowWarningModal(true)}
                className="bg-red text-white px-4 py-2 rounded-lg shadow-md hover:bg-red transition duration-300 scale-100 translate-y-[-40px] translate-x-[40px]"
              >
                Hapus Buku
              </button>
            </div>
