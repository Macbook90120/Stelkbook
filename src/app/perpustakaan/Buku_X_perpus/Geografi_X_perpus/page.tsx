          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-base font-bold translate-y-[-30px]">
                Buku Paket <br /> Mandiri Geografi <br />Untuk SMA/MA <br></br> Kelas X
              </h2>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <button onClick={() => router.push("/perpustakaan/Edit_Buku/Edit_Geografi_X")} className="bg-green-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-600 transition scale-100 duration-300 translate-y-[-30px] translate-x-[40px]">
                Edit Buku
              </button>
              <button
