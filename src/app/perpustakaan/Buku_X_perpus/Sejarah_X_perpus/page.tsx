...
import WarningModalBuku from "./WarningModalBuku9";
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              ...
              Buku paket <br /> Sejarah Indonesia  <br /> Untuk SMA/MA <br /> Kelas X
              </h2>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <button onClick={() => router.push("/perpustakaan/Edit_Buku/Edit_Sejarah_X")} className="bg-green-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-600 transition scale-100 duration-300 translate-y-[-40px] translate-x-[40px]">
                Edit Buku
              </button>
              <button
