  ...
  return (
    <div className="h-screen p-8 bg-gray-50 overflow-y-auto">
      ...
      <div className="mb-8 flex items-center justify-start">
        ...
        <Image src="/assets/Kelas_X/Primary_Direct.png" alt="Breadcrumb Divider" width={10} height={16} className="mx-2" />
        <p className="text-xl font-semibold font-poppins">Buku Paket Sejarah Indonesia</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          <Image src="/assets/Kelas_X/Buku_Sejarah.png" alt="Ekonomi" width={200} height={280} className="rounded-lg shadow-md mb-6" />

          <div className="text-center lg:text-left">
            <h2 className="text-lg font-bold">Buku Paket <br /> Sejarah Indonesia <br /> Untuk SMA/MA <br /> Kelas X </h2>
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button onClick={() => router.push("/perpustakaan/Edit_Buku/Edit_Sejarah_X")} className="bg-green-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-600 flex items-center gap-2">
