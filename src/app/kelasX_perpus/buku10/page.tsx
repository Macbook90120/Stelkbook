...
const Page: React.FC = () => {
  ...
  const { fetchKelas10BookById, deleteBookKelas10, getBookPdfUrl } = useBook(); // ✅ Ambil fungsi getBookPdfUrl
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [bookId, fetchKelas10BookById, getBookPdfUrl]);

  const handleDeleteBook = async (id: number) => {
    try {
      await deleteBookKelas10(id);
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              onClick={() => router.push(`/kelasX_perpus/buku10/Edit_Buku?id=${book.id}`)}
