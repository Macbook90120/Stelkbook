  ...
  return (
    <div className="min-h-screen p-8 bg-gray-50">
      ...
      <div className="mb-8 flex items-center space-x-2">
        ...
        {/* "Siswa" Text */}
        <p className="text-lg font-semibold text-gray-600">Siswa</p>
        ...
        <div className="bg-white border border-gray-300 rounded-lg p-8 shadow-lg max-w-4xl w-full flex items-center space-x-8">
          ...
          <div className="grid gap-4 w-full">
            ...
            <div className="flex justify-center mt-8">
              <button className="bg-red text-white px-6 py-2 rounded-lg shadow-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 translate-x-[-50px]">
                Selesai
              </button>
            </div>
          </div>
