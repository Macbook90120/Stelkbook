...
function Page() {
  ...
  useEffect(() => {
    if (siswaSmpDetail) {
      setForm({
        ...
        password: siswaSmpDetail.password || '',
        nis: siswaSmpDetail.nis || '',
        gender: siswaSmpDetail.gender || '',
        sekolah: 'SMP',
        kelas: siswaSmpDetail.kelas || '',
        avatar: siswaSmpDetail.avatar || '',
      });

      if (siswaSmpDetail.avatar) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (id) {
        ...
        router.push('/admin/Sekolah_Siswa/Data_SMP');
      }
    } catch (error: any) {
  ...
  // Fungsi untuk menghasilkan pilihan kelas khusus SMP
