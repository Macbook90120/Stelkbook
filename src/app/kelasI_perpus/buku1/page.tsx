...
const Page: React.FC = () => {
  ...
  const { fetchKelas1BookById, deleteBookKelas1, getBookPdfUrl } = useBook(); // ✅ Ambil fungsi getBookPdfUrl
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [bookId, fetchKelas1BookById, getBookPdfUrl]);

  const handleDeleteBook = async (id: number) => {
    try {
      await deleteBookKelas1(id);
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              onClick={() => router.push(`/kelasI_perpus/buku1/Edit_Buku?id=${book.id}`)}
