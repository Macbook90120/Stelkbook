...
function Page() {
  ...
  const handleBabClick = (chapterName: string) => {
    router.push(`/Buku_XII/Kimia_XII/${chapterName}_Kimia_XII`); // Navigasi ke bab-1, bab-2, etc.
  };
      ...
      <div className="h-screen p-8 bg-gray-50 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="mb-6">
              <Image
                src="/assets/Kelas_XII/Buku_Kimia.png"
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku Paket Kimia <br /> 1 SMA Kelas XII
              </h2>
