...
function Page() {
  ...
  const handleBabClick = (chapterName: string) => {
    router.push(`/Buku_XII/BahasaIndonesia_XII/${chapterName}_Bahasa_Indonesia_XII`); // Navigasi ke bab-1, bab-2, etc.
  };
      ...
      <div className="h-screen p-8 bg-gray-50 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="mb-6">
              <Image
                src="/assets/Kelas_XII/Buku_Bahasa_Indonesia.png"
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku Paket <br /> Bahasa Indonesia <br /> SMA Kelas XII
              </h2>
