...
function Page() {
  ...
  const handleBabClick = (chapterName: string) => {
    router.push(`/Buku_XII/Fisika_XII/${chapterName}_Fisika_XII`); // Navigasi ke bab-1, bab-2, etc.
  };
    ...
    <>
      ...
      <div className="h-screen p-8 bg-gray-50 overflow-hidden">
        ...
        <div className="mb-8 flex items-center">
          ...
          <p className="text-xl font-semibold font-poppins cursor-pointer" onClick={handleKelasXIIClick}
          >Kelas XII</p>
          <div className="mx-2">
            <Image src="/assets/Kelas_X/Primary_Direct.png" alt="Breadcrumb Divider" width={10} height={16} />
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="mb-6">
              <Image
                src="/assets/Kelas_XII/Buku_Fisika.png"
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku Paket <br /> Mandiri Fisika <br /> SMA/MA Kelas XII
              </h2>
              <ul className="mt-2 text-sm space-y-1">
                ...
                <li className="whitespace-nowrap">
                  <strong>ISBN:</strong> 9786024340261
                </li>
              </ul>
            </div>
          </div>
