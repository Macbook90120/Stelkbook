...
function Page() {
  ...
  const chapters = [
    ...
    "Awal Kehidupan Indonesia",
    "Indonesia Zaman Hindu-Buddha: Silang Budaya Lokal & Global Tahap Awal",
    "Kerajaan-Kerajaan Islam di Indonesia",
  ];

  // Direct route handler
  const handleBabClick = (chapterName: string) => {
    router.push(`/Buku_XII/Sejarah_XII/${chapterName}_Sejarah_XII`); // Navigasi ke bab-1, bab-2, etc.
  };
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              ...
              Buku paket  <br /> Sejarah Indonesia <br /> Untuk SMA/MA Kelas XII
              </h2>
