...
const Page: React.FC = () => {
  ...
  const { fetchKelas9BookById, deleteBookKelas9, getBookPdfUrl } = useBook(); // ✅ Ambil fungsi getBookPdfUrl
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [bookId, fetchKelas9BookById, getBookPdfUrl]);

  const handleDeleteBook = async (id: number) => {
    try {
      await deleteBookKelas9(id);
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              onClick={() => router.push(`/kelasIX_perpus/buku9/Edit_Buku?id=${book.id}`)}
