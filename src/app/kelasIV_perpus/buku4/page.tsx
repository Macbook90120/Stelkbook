...
const Page: React.FC = () => {
  ...
  const { fetchKelas4BookById, deleteBookKelas4, getBookPdfUrl } = useBook(); // ✅ Ambil fungsi getBookPdfUrl
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [bookId, fetchKelas4BookById, getBookPdfUrl]);

  const handleDeleteBook = async (id: number) => {
    try {
      await deleteBookKelas4(id);
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              onClick={() => router.push(`/kelasIV_perpus/buku4/Edit_Buku?id=${book.id}`)}
