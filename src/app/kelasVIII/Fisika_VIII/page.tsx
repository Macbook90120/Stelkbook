    ...
    <div className="min-h-screen bg-gray-50 overflow-y-auto">
      ...
      <main className="pt-16 px-8">
        ...
        <div className="mb-8 flex items-center">
          ...
          <p className="text-xl font-semibold font-poppins">Kelas VIII</p>
          <div className="mx-2">
            <Image
              src="/assets/Kelas_X/Primary_Direct.png"
              alt="Breadcrumb Divider"
          ...
          <p className="text-xl font-semibold font-poppins">Fisika</p>
        </div>
          ...
          <div className="flex flex-col items-center text-center lg:text-left lg:items-start">
            ...
            <div>
              <h2 className="text-lg font-bold">
                Buku Paket <br /> Fisika SMP <br /> Kelas VIII
              </h2>
              <ul className="mt-2 text-sm space-y-1">
                <li><strong>Penerbit:</strong> Erlangga</li>
                <li><strong>Penulis:</strong> Budi Santoso</li>
                <li><strong>Tahun:</strong> 2021</li>
                <li><strong>ISBN:</strong> 9786024341237</li>
              </ul>
