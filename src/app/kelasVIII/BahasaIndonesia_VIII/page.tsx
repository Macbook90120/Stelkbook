    ...
    <div className="min-h-screen bg-gray-50 overflow-y-auto">
      ...
      <main className="pt-16 px-8">
        ...
        <div className="mb-8 flex items-center">
          ...
          <p className="text-xl font-semibold font-poppins">Bahasa Indonesia</p>
        </div>
          ...
          <div className="flex flex-col items-center text-center lg:text-left lg:items-start">
            <div className="mb-6">
              <Image
                ...
                alt="Bahasa Indonesia SMP Kelas VIII"
                width={200}
                height={280}
            ...
            <div>
              <h2 className="text-lg font-bold">
                Buku Paket <br /> Bahasa Indonesia <br /> SMP Kelas VIII
              </h2>
              <ul className="mt-2 text-sm space-y-1">
                ...
                <li><strong>ISBN:</strong> 9786022997305</li>
              </ul>
