      ...
      <main className="pt-20 px-8"> {/* Added padding to avoid overlap with navbar */}
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="mb-6">
              <Image
                src="/assets/Lainnya/Organic_Chemistry.jpg"
                alt="Buku kimia"
                width={200}
                height={280}
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku <br /> Organic Chemistry <br/> Second Edition
              </h2>
              <ul className="mt-2 text-sm space-y-1">
                <li className="whitespace-nowrap">
                  <strong>Penerbit:</strong> Michael B.Smith
                </li>
                <li className="whitespace-nowrap">
                  <strong>Penulis:</strong> Michael B.Smith
                </li>
                <li className="whitespace-nowrap">
                  <strong>Tahun:</strong> 2009
                </li>
                <li className="whitespace-nowrap">
                  <strong>ISBN:</strong> 978602299791
                </li>
              </ul>
            </div>
          </div>
