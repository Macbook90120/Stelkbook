...
const Page: React.FC = () => {
  ...
  const { fetchKelas5BookById, deleteBookKelas5, getBookPdfUrl } = useBook(); // ✅ Ambil fungsi getBookPdfUrl
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [bookId, fetchKelas5BookById, getBookPdfUrl]);

  const handleDeleteBook = async (id: number) => {
    try {
      await deleteBookKelas5(id);
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              onClick={() => router.push(`/kelasV_perpus/buku5/Edit_Buku?id=${book.id}`)}
