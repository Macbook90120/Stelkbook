...
function Page() {
  ...
  const handleBabClick = (chapterName: string) => {
    router.push(`Matematika_X_Guru/${chapterName}_Matematika_X_Guru`); // Navigasi ke bab-1, bab-2, etc.
  };
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-lg font-bold">
                Buku Paket <br /> Matematika Untuk <br /> SMA/MA Kelas X Kelompok Wajib
              </h2>
